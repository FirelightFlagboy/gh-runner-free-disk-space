...
Please don't hesitate to [submit issues](https://github.com/FirelightFlagboy/gh-runner-free-disk-space/issues) to report problems or suggest new features (or sets of files to help remove).
...
jobs:
  free-disk-space:
    ...
    - name: Free Disk Space (Ubuntu)
      uses: FirelightFlagboy/gh-runner-free-disk-space
      with:
